...
#define GET_CHANNEL_FUNCTION_LEN (BP_HEADER_DIM + LEN_GET_CHANNEL_FUNCTION)
...
#define ANS_GET_CHANNEL_FUNCTION_LEN (BP_HEADER_DIM + LEN_ANS_GET_CHANNEL_FUNCTION)
#define ANS_GET_CHANNEL_FUNCTION_LEN_CRC (ANS_GET_CHANNEL_FUNCTION_LEN + 1)
#ifdef BP_USE_CRC
#define CTRL_ANS_GET_CHANNEL_FUNCTION ANS_GET_CHANNEL_FUNCTION_LEN_CRC
#else
#define CTRL_ANS_GET_CHANNEL_FUNCTION ANS_GET_CHANNEL_FUNCTION_LEN
#endif
