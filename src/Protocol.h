...
#define LEN_GET_PRODUCT_TYPE 33
#define ANS_ARG_GET_PRODUCT_SIZE_POS BP_HEADER_DIM
#define LEN_ANS_GET_PRODUCT (BP_HEADER_DIM + LEN_GET_PRODUCT_TYPE)
#define LEN_ANS_GET_PRODUCT_CRC (LEN_ANS_GET_PRODUCT + 1)
#ifdef BP_USE_CRC
#define CTRL_ANS_MSG_GET_PRODUCT_LEN LEN_ANS_GET_PRODUCT_CRC
#else
#define CTRL_ANS_MSG_GET_PRODUCT_LEN LEN_ANS_GET_PRODUCT
#endif
//
//
//
